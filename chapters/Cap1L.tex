...
egípicios sobre presos de guerra que datam de 5000 a.C (MEMÓRIA, 2004). Há indícios de que 3000 anos a.C. existem também registros egípicios
de falta de mão-de-obra relacionada a construção de pirâmides,
conforme evidenciam pesquisas arqueológicas. No 4o. livro do Velho
...
% No japao o primeiro recenseamento surgiu em 86 a.C, no tempo do
%Imperador Soujin, onde as atividades da população eram registradas
%para examinar a sua evolução.\vskip0.3cm
...
diferente. Como está escrito na Bíblia, no Novo Testamento, Lucas
...
Segundo Rao (1977), a estatística pode ser definida de uma forma
...
Dados descrevem fenômenos (ou processos) ou entidades que são objetos de estudo ou análise. Desta forma, dados correspondem a atributos que podem ser caracterizados de acordo com diferentes critérios, sendo considerado a matéria-prima sobre o qual o pesquisador irá aplicar os métodos estatísticos.
...
\begin{itemize}
\item Hipótese de Nulidade, cujo o símbolo é representado da seguinte forma $H_{0}$.
...
As hipóteses estatísticas que podem ser testadas numericamente são utilizadas nos seguintes casos:
...
\begin{itemize}
\item \textbf{Pesquisa Básica ou Fundamental}: é aquela cujo objetivo é adquirir conhecimentos novos que contribuam para o avanço da ciência, sem que haja uma aplicação prática prevista. Neste tipo de pesquisa, o investigador acumula conhecimentos e informações que podem, eventualmente, levar a resultados acadêmicos ou aplicados importantes.Há autores que incluem, neste tipo, as pesquisas acadêmicas, aquelas realizadas na instituição de ensino superior como parte das atividades de ensino-aprendizagem, tal como nos trabalhos de conclusão de curso (KENDALL, 2003). 
\item \textbf{Pesquisa Aplicada ou Tecnológica}:é o tipo de pesquisa cujo objetivo é produzir conhecimentos científicos para aplicação prática voltada para a solução de problemas concretos, específicos da vida moderna. È a pesquisa que, além de produzir conhecimento, gera novos processos tecnológicos e novos produtos, com resultados práticos imediatos em termos econômicos e na melhoria da qualidade de vida (BISSEL, 2004).
\end{itemize}
...
\begin{enumerate}
  \item \textbf{População ou Universo} : É o conjunto de todos os elementos relativos
  a um determinado fenômeno que possuem ao menos uma característica em comum
...
\subsection{Erro, Fração Amostral e Nível de Confiança}
...
amostra e o tamanho da população; \item \textbf{Nível de
...
\subsection{Estatística em outras Áreas}


\textbf{Bioestatística:} É a metodologia estatística aplicada às ciências biológicas, com a finalidade em planejar, coletar, organizar, resumir, analisar e interpretar os dados,
...
\textbf{Geoestatística:} A Geoestatística tem por objetivo a
...
\textbf{Econometria:} A Econometria é um conjunto de ferramentas estatísticas com o objetivo de entender a relação entre variáveis econômicas através da aplicação de um modelo estatístico.\vskip0.3cm
...
\textbf{Quimiometria:} Quimiometria é a ciência relacionada a
...
A necessidade de uma história pode parecer perturbadora para cientistas e jornalistas, que podem equipará-la a inventar coisas, dar uma guinada nas coisas ou exagerar nos resultados. No entanto, essa perspectiva perde o importante papel que as histórias desempenham no raciocínio e na memória.\vskip0.3cm
...
\subsection{O Que é uma História Estatística}
...
\subsection{Por Que Contar uma História Estatística}

Uma agência estatística deve querer contar uma história sobre seus dados por pelo menos dois motivos.\vskip0.3cm 
