...
O título deve ser escrito após o número da tabela, devendo ser separado do número por espaço, hífen e espaço, em letra maiúscula como o número.
...
\inic Quando um relatório técnico possui tabelas  e Quadros, é necessário inserir uma Lista de Tabelas e e Quadros de forma separada.
...
\centering
    {
\caption{Exemplo de Tabela Rotacionada devido a Ultrapassagem da Margem (Item 9) , referente a Frota de Veículos Registrados em alguns Municípios Paraenses em setembro de 2020.}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Número de Veículos Registrados do tipo Motocicleta no Estado do Pará durante o período de 2010 a 2020.}
    \label{obitos}
    \vspace{0.1cm}
\begin{tabular}{c|c}
  \hline\hline
...
\inic È a série cujos dados estão dispostos em correspondência com o \textbf{Local}, nesta série o elemento de variação é o lugar (município, bairro), ou seja, varia o local, mas o tempo (época) e o fato (espécie) permanecem constantes (fixos).
...
\begin{table}[!htb]
    \centering
    {
    \caption{Vítimas Fatais por Acidentes de Trânsito na Região Metropolitana de Belém em 2020.}
    \label{obitos2}
    \vspace{0.1cm}
\begin{tabular}{l|c}
  \hline\hline
  % after \\: \hline or \cline{col1-col2} \cline{col3-col4} ...
  Municípios   & Vitimas Fatais  \\
  \hline\hline
  Ananindeua    &  38 \\
  Benevides     &  11 \\
  Belém         &  104 \\
...
\begin{table}[!htb]
    \centering
    {
    \caption{Frota de Veículos segundo o Tipo Vistoriados no Município de Belém em 2020.}
    \label{obitos2}
    \vspace{0.1cm}
\begin{tabular}{l|c}
  \hline\hline
...
\end{tabular}}
\\
\hspace{-2.0cm} Fonte: Detran-Pa, 2020.
\end{table}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Estatura dos Funcionários do DETRAN sede no muncípio de Belém em 2020.}
    \label{estatura}
    \vspace{0.2cm}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Frequências das Estatura dos Funcionários do DETRAN sede no muncípio de Belém em 2020.}
    \label{estatura2}
    \vspace{0.2cm}
\begin{tabular}{c|c}
\hline\hline
...
\begin{table}[!htb]
    \centering{
    \caption{Esquema Geral para Construção da Distribuição de Frequência tradicional}
    \label{tox}
    \vspace{0.1cm}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Medidas de Dosagem Alcoólica de Etilômetros coletadas na Operação Lei Seca no Município de Belém em 2020.}
    \label{estatura}
    \vspace{0.2cm}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Rol das medidas de dosagem Alcoólica de Etilômetros coletadas na Operação Lei Seca no município de Belém em 2020.}
    \label{estatura}
    \vspace{0.2cm}
...
\begin{table}[!htb]
    \centering
    {
    \caption{Distribuição de Frequência das Medidas de Medidas de Dosagem Alcoólica da Operação Lei Seca em Belém em 2020.}
    \label{toxalimentar}
    \vspace{-0.1cm}
\begin{tabular}{l|c}
  \hline\hline
