...
\begin{figure}
    \centering
\includegraphics[scale=0.2,height=190pt,width=11cm]{figures/poligono1.jpeg}
    \caption{Polígono de Frequências Absoluta das Idades de Vítimas Fatais por Acidentes de Trânsito, Belém em 2022.}
    \label{fig:my_label25}
\end{figure}
...
\begin{figure}
    \centering
\includegraphics[scale=0.2,height=190pt,width=11cm]{figures/poligono1.jpeg}
    \caption{Polígono de Frequências Relativa das Idades de Vítimas Fatais por Acidentes de Trânsito, Belém em 2022.}
    \label{fig:my_label25}
\end{figure}
