...
apresentação é feita em três ou mais variáveis quantitativas. A sua análise exige mais
...
\begin{figure}[H]
    \centering
\includegraphics[scale=0.25,height=250pt,width=12cm]{figures/radarplot1.jpeg}
...
\begin{figure}[H]
    \centering
\includegraphics[scale=0.25,height=242pt,width=11cm]{figures/boxplot_dosagem.jpeg}
...
\begin{figure}[H]
    \centering
\includegraphics[scale=0.25,height=242pt,width=11cm]{figures/boxplot_dosagem_jitter.jpeg}
