...
\begin{figure}[H]
    \centering
\includegraphics[scale=0.20,height=200pt,width=11cm]{figures/violinplot_Tradicional.jpeg}
    \caption{\textbf{ViolinoPlot Tradicional}: Dosagem Alcoólica de Vítimas Fatais por Acidentes de Trânsito, Região Metropolitrana de Belém em 2022.}
    \label{fig:my_label25}
\end{figure}
...
\begin{figure}[H]
    \centering
\includegraphics[scale=0.20,height=200pt,width=11cm]{figures/violinplot_jitter.jpeg}
    \caption{\textbf{ViolinoPlot com Efeito Jitter}: Dosagem Alcoólica de Vítimas Fatais por Acidentes de Trânsito, Região Metropolitrana de Belém em 2022.}
    \label{fig:my_label25}
\end{figure}
