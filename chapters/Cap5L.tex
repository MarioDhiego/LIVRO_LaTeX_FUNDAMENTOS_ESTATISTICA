...
Para a construção de um diagrama ramo-e-folhas, não há regras fixas para construi-los, mas a idéia básica é dividir cada observação em duas partes: desenhe uma linha vertical e coloque os primeiros digitos de cada classe chamdo de (\textbf{ramos}) no lado esquerdo da linha vertical. Os números no lado direito da linha vertical representam o segundo dígito de cada observação, sendo estes as \textbf{folhas}.\vskip0.3cm


\begin{table}[!htb]
    \centering
    {
    \caption{Exemplo Simples sobre o Diagrama de Ramos-e-Folhas, descrito em formato de Tabela de frequências.}
    \label{ramosfolhas}
    \vspace{0.1cm}
\begin{tabular}{c|l|c}
\hline
